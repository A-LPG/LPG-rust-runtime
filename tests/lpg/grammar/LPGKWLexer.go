...
func NewLPGKWLexer(inputChars []rune, identifierKind int)*LPGKWLexer{
    ...
    my.keywordKind[0] = identifierKind
        ...
        my.keywordKind[1] = (LPGKWLexerexp.ALIAS_KEY)
        ...
        my.keywordKind[2] = (LPGKWLexerexp.AST_KEY)
        ...
        my.keywordKind[3] = (LPGKWLexerexp.DEFINE_KEY)
        ...
        my.keywordKind[4] = (LPGKWLexerexp.DISJOINTPREDECESSORSETS_KEY)
        ...
        my.keywordKind[5] = (LPGKWLexerexp.DROPRULES_KEY)
        ...
        my.keywordKind[6] = (LPGKWLexerexp.DROPSYMBOLS_KEY)
        ...
        my.keywordKind[7] = (LPGKWLexerexp.EMPTY_KEY)
        ...
        my.keywordKind[8] = (LPGKWLexerexp.END_KEY)
        ...
        my.keywordKind[9] = (LPGKWLexerexp.ERROR_KEY)
        ...
        my.keywordKind[10] = (LPGKWLexerexp.EOL_KEY)
        ...
        my.keywordKind[11] = (LPGKWLexerexp.EOF_KEY)
        ...
        my.keywordKind[12] = (LPGKWLexerexp.EXPORT_KEY)
        ...
        my.keywordKind[13] = (LPGKWLexerexp.GLOBALS_KEY)
        ...
        my.keywordKind[14] = (LPGKWLexerexp.HEADERS_KEY)
        ...
        my.keywordKind[15] = (LPGKWLexerexp.IDENTIFIER_KEY)
        ...
        my.keywordKind[16] = (LPGKWLexerexp.IMPORT_KEY)
        ...
        my.keywordKind[17] = (LPGKWLexerexp.INCLUDE_KEY)
        ...
        my.keywordKind[18] = (LPGKWLexerexp.KEYWORDS_KEY)
        ...
        my.keywordKind[19] = (LPGKWLexerexp.SOFT_KEYWORDS_KEY)
        ...
        my.keywordKind[20] = (LPGKWLexerexp.NAMES_KEY)
        ...
        my.keywordKind[21] = (LPGKWLexerexp.NOTICE_KEY)
        ...
        my.keywordKind[22] = (LPGKWLexerexp.TERMINALS_KEY)
        ...
        my.keywordKind[23] = (LPGKWLexerexp.RECOVER_KEY)
        ...
        my.keywordKind[24] = (LPGKWLexerexp.RULES_KEY)
        ...
        my.keywordKind[25] = (LPGKWLexerexp.START_KEY)
        ...
        my.keywordKind[26] = (LPGKWLexerexp.TRAILERS_KEY)
        ...
        my.keywordKind[27] = (LPGKWLexerexp.TYPES_KEY)
